...
function RegistrarPontos(req, res) {
    ...
    if (Pontos == undefined) {
        ...
        usuarioModel.RegistrarPontos(Pontos, fkUsuario, Acertos)
        .then(
            function (resultado) {
                res.json(resultado);
            }
    ...
    function RegistrarComentario(req, res) {
        ...
        if (Comentario == undefined) {
            res.status(400).send("Seus Comentarios está Undefined");
        } else{
    
            usuarioModel.RegistrarComentario(Comentario, fk_Usuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
